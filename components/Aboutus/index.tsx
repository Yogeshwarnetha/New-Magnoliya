...
import { getAboutUs } from '@/apirequests/about';
...
const About = () => {
    ...
    useEffect(() => {
        const fetchAboutData = async () => {
            try {
                ...
                console.debug('[AboutPage] getAboutUs response:', response);
                ...
                if (response.ok && response.data) {
                    ...
                    setAboutData({
                        hero_title: "About Magnoliya Grand",
                        hero_subtitle: "Where meaningful moments become unforgettable celebrations",
                        carousel_slides: [],
                        ...
                        sustainability_description: "At Magnoliya Grand, we believe that unforgettable events can be hosted responsibly. We are committed to reducing our environmental footprint while still delivering exceptional experiences for our guests.",
                        ...
                        sustainability_commitment: "By choosing Magnoliya Grand, you're not just celebrating a moment — you're supporting a greener future."
                    });
                }
            } catch (error) {
    ...
    // Get carousel slides from API data or use fallback
    const carouselSlides = aboutData?.carousel_slides && aboutData.carousel_slides.length > 0 
        ? aboutData.carousel_slides 
        : [
            {
                id: 1,
                image: "https://images.unsplash.com/photo-1519225421980-715cb0215aed?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
                title: aboutData?.hero_title || "About Magnoliya Grand",
                description: aboutData?.hero_subtitle || "Where meaningful moments become unforgettable celebrations"
            },
            {
                id: 2,
    ...
    return (
        <div className="relative min-h-screen bg-white">
            ...
            <div className="relative z-10">
                ...
                {/* Enhanced Our Story Section - Dynamic */}
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-5xl md:text-6xl font-serif font-light text-gray-900 mb-6">
                                {aboutData?.story_title || "Our Story & Legacy"}
                            </h2>
                        </div>
                ...
                {/* Enhanced Sustainability Section - Dynamic */}
                <section className="py-24 relative overflow-hidden">
                    {/* Background pattern */}
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-4xl md:text-5xl font-serif font-light text-gray-900 mb-6">
                                {aboutData?.sustainability_title || "Our Commitment to Sustainability"}
                            </h2>
                            <p className="text-xl text-gray-600 max-w-3xl mx-auto font-light">
                                {aboutData?.sustainability_description || "At Magnoliya Grand, we believe that unforgettable events can be hosted responsibly. We are committed to reducing our environmental footprint while still delivering exceptional experiences for our guests."}
                            </p>
                        </div>

                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
                            {aboutData?.sustainability_features?.map((feature, index) => (
                                <div
                                    key={index}
                        ...
                        <div className="mt-16 text-center">
                            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 max-w-2xl mx-auto border border-gold/20">
                                <p className="text-2xl font-serif font-light text-green-800">
                                    {aboutData?.sustainability_commitment || "By choosing Magnoliya Grand, you're not just celebrating a moment — you're supporting a greener future."}
                                </p>
                            </div>
                        </div>
                    </div>
